...
# --------------------------------------------------------------------------
# Frame capture / tokenization (spec 1/2 -- capture-frame). Logic lives in
# builder_frame; re-exported so commands.py and the test suite reach it via
# the builder facade.
# --------------------------------------------------------------------------
_FRAME_TOKEN_GEOMETRY = _builder_frame._FRAME_TOKEN_GEOMETRY
_member_map = _builder_frame._member_map
_extract_frame_params = _builder_frame._extract_frame_params
_tokenize_frame = _builder_frame._tokenize_frame
_build_frame_catalog = _builder_frame._build_frame_catalog
