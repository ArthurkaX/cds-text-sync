...
from cds_static_analyzer.st import blocks, decl, symbols
from cds_static_analyzer.file_directives import is_ignored
from cds_static_analyzer.staleness import staleness_diagnostic
...
def _report_unparsed_units(rule, ctx, result):
    ...
    """
    from cds_static_analyzer.st import kinds as _K
