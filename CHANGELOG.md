...
- The daemon no longer carries a version of its own: the banner and dashboard now report the release version (`3.2.0`) instead of a separate `2.8.x` track that said nothing about which release was installed.
