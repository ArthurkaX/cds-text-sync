...
def check_wheel_assets():
    ...
    with tempfile.TemporaryDirectory() as wheel_dir:
        ...
        if len(rule_py) != 18:
            raise SystemExit(f"expected 18 rule .py files in wheel, got {len(rule_py)}")
        if len(docs) != 18:
            raise SystemExit(f"expected 18 .md in wheel, got {len(docs)}")
...
def check_wheel_install():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        if ids != {"CTS0001", "CTS0002", "CTS0003", "CTS0004", "CTS0006", "CTS0007", "CTS0008", "CTS0009", "CTS0010", "CTS0011", "CTS0012", "CTS0013", "CTS0014", "CTS0015", "CTS0016", "CTS0017", "CTS0018", "CTS0019"}:
            raise SystemExit(
        ...
        print("wheel install OK: venv entry point lists 18 human rules, selftest passes")
